...
// Page object
$WUserlevelpermissionsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fw_userlevelpermissionsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fw_userlevelpermissionsadd = currentForm = new ew.Form("fw_userlevelpermissionsadd", "add");
    ...
    fw_userlevelpermissionsadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fw_userlevelpermissionsadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fw_userlevelpermissionsadd.validate = function () {
    ...
    // Form_CustomValidate
    fw_userlevelpermissionsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fw_userlevelpermissionsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fw_userlevelpermissionsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fw_userlevelpermissionsadd" id="fw_userlevelpermissionsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<span id="el_w_userlevelpermissions_userlevelid">
...
<span id="el_w_userlevelpermissions__tablename">
