    ...
    <div class="container">
        <div class="row mb-5">
            ...
            ?>
                <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                    <div class="card pelatihan-mendatang h-100" style="border:0; box-shadow: 3px 4px 6px rgba(0, 0, 0, 0.25);">
                        <img src="files/<?php echo $row["gambar"]; ?>" class="card-img-top" alt="<?php echo $row["judul_pelatihan"]; ?>" style="height: 400px; object-fit: cover;">
                        <div class="card-body d-flex flex-column">
                            <h5 class="card-title" style="font-size: 18px; font-weight: bold;"><?php echo $row["judul_pelatihan"]; ?></h5>
                            ...
                            <a href="wpelatihanview/<?php echo $row["pelatihan_id"]; ?>" class="btn btn-success btn-block mt-auto">Lihat Detail</a>
                        </div>
                    </div>
                </div>
            <?php
            ...
            if ($jumlahpelatihan == 0) {
                echo '<span class="alert alert-warning text-center w-100">Pelatihan belum tersedia</span>';
            }
            ?>
        </div>
    </div>
