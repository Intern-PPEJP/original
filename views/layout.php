...
<style>
.ew-brand-image{width:80px !important;}
</style>
<!-- Navbar -->
...
<link rel="shortcut icon" type="image/x-icon" href="<?= BasePath() ?>/favicon-kemendag.ico">
<link rel="icon" type="image/x-icon" href="<?= BasePath() ?>/favicon-kemendag.ico">
    ...
    <nav class="<?= Config("NAVBAR_CLASS") ?>">
        ...
        <ul id="ew-navbar" class="navbar-nav">
            ...
            <a class="navbar-brand d-none d-md-block" href="#"  onclick="return false;">
                <img src="<?= GetUrl("images/Logo-Kemendag.png") ?>" alt="" class="brand-image ew-brand-image">
            </a>
        </ul>
        <!-- Right navbar links -->
