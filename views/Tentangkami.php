...
<div class="container-fluid" style="background-color: #031A31; padding:20px 0px;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="m-0" style="color: white; font-weight:bold; font-size: 20px;">TENTANG KAMI</h1>
            </div>
        </div>
    </div>
</div>
...
<div class="row ">
	...
	<div class="col-md-12">
		Pusat Pelatihan Sumber Daya Manusia Ekspor dan Jasa Perdagangan (PPEJP) menyelenggarakan fungsi:<ul>
...
<br><br>
<div class="row ">
	<center><h4 class="text-bold">KEBIJAKAN MUTU PPEJP</h4></center>
	<div class="col-md-12">
...
<div class="row mt-5">
	<center><h4 class="text-bold">KERJASAMA</h4></center>
...
<div class="row mt-5">
	...
	<div class="col-md-12 text-center">
			<p>Klik tombol di bawah untuk mengisi form untuk kami hubungi kembali</p><br>
