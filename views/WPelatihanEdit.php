...
var fw_pelatihanedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fw_pelatihanedit = currentForm = new ew.Form("fw_pelatihanedit", "edit");
    ...
    fw_pelatihanedit.addFields([
        ...
        ["Last_Updated", [fields.Last_Updated.visible && fields.Last_Updated.required ? ew.Validators.required(fields.Last_Updated.caption) : null], fields.Last_Updated.isInvalid],
    ...
    // Validate form
    fw_pelatihanedit.validate = function () {
    ...
    // Form_CustomValidate
    fw_pelatihanedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fw_pelatihanedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fw_pelatihanedit.lists.jenis_pelatihan = <?= $Page->jenis_pelatihan->toClientList($Page) ?>;
    fw_pelatihanedit.lists.Activated = <?= $Page->Activated->toClientList($Page) ?>;
    loadjs.done("fw_pelatihanedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fw_pelatihanedit" id="fw_pelatihanedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->pelatihan_id->Visible) { // pelatihan_id ?>
    <div id="r_pelatihan_id" class="form-group row">
        <label id="elh_w_pelatihan_pelatihan_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->pelatihan_id->caption() ?><?= $Page->pelatihan_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->pelatihan_id->cellAttributes() ?>>
<span id="el_w_pelatihan_pelatihan_id">
...
<input type="hidden" data-table="w_pelatihan" data-field="x_pelatihan_id" data-hidden="1" name="x_pelatihan_id" id="x_pelatihan_id" value="<?= HtmlEncode($Page->pelatihan_id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fw_pelatihanedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fw_pelatihanedit", "x_tawal", {"ignoreReadonly":true,"useCurrent":false,"format":7});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fw_pelatihanedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fw_pelatihanedit", "x_takhir", {"ignoreReadonly":true,"useCurrent":false,"format":7});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fw_pelatihanedit", "editor"], function() {
	ew.createEditor("fw_pelatihanedit", "x_topik_bahasan", 35, 4, <?= $Page->topik_bahasan->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span>
</div></div>
...
<script>
loadjs.ready(["fw_pelatihanedit", "editor"], function() {
	ew.createEditor("fw_pelatihanedit", "x_catatan", 35, 4, <?= $Page->catatan->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span>
</div></div>
...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->Activated->isInvalidClass() ?>" data-table="w_pelatihan" data-field="x_Activated" name="x_Activated[]" id="x_Activated_553270" value="1"<?= ConvertToBool($Page->Activated->CurrentValue) ? " checked" : "" ?><?= $Page->Activated->editAttributes() ?> aria-describedby="x_Activated_help">
    <label class="custom-control-label" for="x_Activated_553270"></label>
</div>
