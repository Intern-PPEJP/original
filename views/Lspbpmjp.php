...
<body>
    ...
    <style>
        ...
        tbody td {
            ...
            border: 1px solid #dddddd;
            text-align: left;
            /* Rata kiri untuk isi kolom */
        }

        tbody td:nth-child(1) {
            text-align: center;
            /* Rata tengah isi untuk kolom NO */
        }

        tbody td:nth-child(2) {
            text-align: left;
            /* Rata kiri untuk isi kolom KODE UNIT */
        }

        tbody td:nth-child(3) {
            text-align: left;
            /* Rata kiri untuk isi kolom JUDUL UNIT KOMPETENSI */
        }

        tbody tr:nth-child(even) {
            background-color: #f3f3f3;
            /* memberi warna yang berbeda tiap baris*/
        }

        .custom-card {
            display: inline-block;
            padding: 25px 20px 10px 20px;
            /* Padding atas 25px, bawah 10px, kiri/kanan 20px */
