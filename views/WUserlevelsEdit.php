...
// Page object
$WUserlevelsEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fw_userlevelsedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fw_userlevelsedit = currentForm = new ew.Form("fw_userlevelsedit", "edit");

    // Add fields
    var currentTable = <?= JsonEncode(GetClientVar("tables", "w_userlevels")) ?>,
        fields = currentTable.fields;
    if (!ew.vars.tables.w_userlevels)
        ew.vars.tables.w_userlevels = currentTable;
    fw_userlevelsedit.addFields([
    ...
    // Validate form
    fw_userlevelsedit.validate = function () {
    ...
    // Form_CustomValidate
    fw_userlevelsedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fw_userlevelsedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fw_userlevelsedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fw_userlevelsedit" id="fw_userlevelsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
