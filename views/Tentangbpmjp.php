...
<div class="container-fluid " style="background-color: #3A8F53; padding:20px 0px;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="m-0" style="color: white;font-weight:bold">BALAI PELATIHAN SDM METROLOGI, MUTU DAN JASA PERDAGANGAN</h1>
            </div>
        </div>
    </div>
</div>
...
<div class="container text-justify mt-5">
    <div class="row slim">
		...
		<div class="col-md-12">
		<div style="position:absolute;left:10px;top:395px;width:280px;background:#031A31;margin-left:2px;color:#fff;padding:10px;">
			...
			<img src="images/pages/kepala-bpmjp-2.jpg" style="width: 280px;height:auto;float: left !important;margin: 10px 35px 20px 0;"></img>
	...
	<div class="row ">
		<center><h2 class="text-bold mb-4 t-5">SEJARAH SINGKAT</h2></center>
		<div class="col-md-12">
	...
	<center><h2 class="text-bold mb-4 mt-5">FASILITAS</h2></center>
