...
<div class="container grid pb-5">
    <div class="row">
        <div class="col-md-12 p-0">
            <h3 style="margin-bottom:0;background: #031a31;border-radius: 0 53.1rem 0 0;padding: 5px 20px ;color: #fff;width:300px;">Berita Terbaru</h3>
        </div>
    </div>
	...
	<a href="berita?baca=<?php echo $last_berita["id"]; ?>" style="color:#fff;text-decoration:none;padding:0;"> 
        <div class="col-md-12 p-0">
			...
			<div  style="background:#031a31bf;padding:10px 30px 10px 30px;border-radius: 0px 0px 10px 10px;">
                ...
                <div style="font-size: .7em;"><?php echo tanggal_indo($last_berita["tanggal"]); ?></div>
			</div>
            </div>
        </div>
	...
	<a href="berita?baca=<?php echo $row["id"]; ?>" style="color:#000;text-decoration:none;"> 
            ...
            <div style="font-size:.8em; color: #000;  font-weight: 500;" class="mb-1text-left">
...
<div class="container">	
    <div class="row mb-5">
        <div class="col-md-8">
             ...
             <div style="font-size:.8em; color: gray;" class="mt-2 mb-3"><?php echo tanggal_indo($lihat_berita["tanggal"]); ?></div>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
        ...
        <div class="col-md-4"><h3 style="margin-bottom:10px;background: #031a31;border-radius: 0 53.1rem 0 0;padding: 5px;color: #fff;">Berita Lainnya</h3>
	...
	<div class="col-md-12 mb-3">
            <div style="background-image: url('images/news/<?php echo $gambar_berita_lain[0]; ?>'); background-size: cover;height: 200px;border-radius: 10px;">
            </div>
            <div style="font-size:.8em; color: #000;  font-weight: 500;" class="mb-1text-left">
