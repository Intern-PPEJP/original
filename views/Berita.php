...
<style>
    ...
    body, p, table, div {
        font-family: 'Poppins', sans-serif !important; /* Menggunakan font Poppins */
        font-size: 16px !important; /* Ukuran teks 16px */
    }
    ...
    .text-justify {
        font-size: 16px; /* Ukuran teks di dalam berita */
        font-family: 'Poppins', sans-serif !important;
    }
</style>
-->
    ...
    <div class="row postList mb-5">
        ...
        <div class="col-md-3 mb-4">
            <a href="berita?baca=<?php echo $row["id"]; ?>" style="color:#000;text-decoration:none;"> 
                ...
                <div style="font-size:20px; color: #000;  font-weight: 500;" class="mb-1text-left">
                    <?php echo $row["judul"]; ?>
                </div>
