...
class Akun
{
    ...
    // Table name
    public $TableName = 'akun.php';

    // Page object name
    public $PageObjName = "Akun";
    ...
    public function __construct()
    {
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'akun.php');
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $Breadcrumb->add("custom", "akun", CurrentUrl(), "", "akun", true);
        $this->Heading = $Language->TablePhrase("akun", "TblCaption");
    }
