 ...
 * Page class
 */
class WOrdersView extends WOrders
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WOrdersView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("order_id") ?? Route("order_id")) !== null) {
                ...
                $returnUrl = "worderslist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "worderslist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "worderslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->bukti_pembayaran->ViewCustomAttributes = "style='width:50px;'";
