 ...
 * Page class
 */
class WBeritaView extends WBerita
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WBeritaView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "wberitalist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "wberitalist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "wberitalist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    public function loadRowValues($rs = null)
    {
        ...
        $this->gambar_url->setDbValue($row['gambar_url']);
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->tanggal_publikasi->ViewValue = FormatDateTime($this->tanggal_publikasi->ViewValue, 0);
            ...
            // gambar_url
            $this->gambar_url->ViewValue = $this->gambar_url->CurrentValue;
            $this->gambar_url->ViewCustomAttributes = "";

            // kategori_id
            $this->kategori_id->ViewValue = $this->kategori_id->CurrentValue;
            $this->kategori_id->ViewValue = FormatNumber($this->kategori_id->ViewValue, 0, -2, -2, -2);
            ...
            // gambar_url
            $this->gambar_url->LinkCustomAttributes = "";
            $this->gambar_url->HrefValue = "";
            $this->gambar_url->TooltipValue = "";
