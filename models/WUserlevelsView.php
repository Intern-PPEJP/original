 ...
 * Page class
 */
class WUserlevelsView extends WUserlevels
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WUserlevelsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("userlevelid") ?? Route("userlevelid")) !== null) {
                ...
                $returnUrl = "wuserlevelslist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "wuserlevelslist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "wuserlevelslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("wuserlevelslist"), "", $this->TableVar, true);
        $pageId = "view";
