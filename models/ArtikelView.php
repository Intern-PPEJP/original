 ...
 * Page class
 */
class ArtikelView extends Artikel
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArtikelView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "artikellist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "artikellist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "artikellist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("artikellist"), "", $this->TableVar, true);
        $pageId = "view";
