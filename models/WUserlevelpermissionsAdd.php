 ...
 * Page class
 */
class WUserlevelpermissionsAdd extends WUserlevelpermissions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WUserlevelpermissionsAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("wuserlevelpermissionslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "wuserlevelpermissionslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "wuserlevelpermissionsview") {
