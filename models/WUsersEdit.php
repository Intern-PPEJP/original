 ...
 * Page class
 */
class WUsersEdit extends WUsers
{
    use MessagesTrait;
    ...
    protected function editRow()
    {
        ...
        if ($this->user_email->CurrentValue != "") { // Check field with unique index
            $filterChk = "(`user_email` = '" . AdjustSql($this->user_email->CurrentValue, $this->Dbid) . "')";
        ...
        if (!$rsold) {
            ...
            // pass
            $this->pass->setDbValueDef($rsnew, $this->pass->CurrentValue, null, $this->pass->ReadOnly || Config("ENCRYPTED_PASSWORD") && $rsold['pass'] == $this->pass->CurrentValue);
            ...
            $this->aktif->setDbValueDef($rsnew, $tmpBool, "N", $this->aktif->ReadOnly);
