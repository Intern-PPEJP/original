...
class Webinar
{
    ...
    // Table name
    public $TableName = 'webinar.php';

    // Page object name
    public $PageObjName = "Webinar";
    ...
    public function __construct()
    {
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'webinar.php');
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $Breadcrumb->add("custom", "webinar", CurrentUrl(), "", "webinar", true);
        $this->Heading = $Language->TablePhrase("webinar", "TblCaption");
    }
