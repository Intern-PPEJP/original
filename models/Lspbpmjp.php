...
class Lspbpmjp
{
    ...
    // Table name
    public $TableName = 'lsp-bpmjp.php';

    // Page object name
    public $PageObjName = "Lspbpmjp";
    ...
    public function __construct()
    {
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'lsp-bpmjp.php');
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $Breadcrumb->add("custom", "lspbpmjp", CurrentUrl(), "", "lspbpmjp", true);
        $this->Heading = $Language->TablePhrase("lspbpmjp", "TblCaption");
    }
