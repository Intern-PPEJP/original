 ...
 * Page class
 */
class WUserlevelsDelete extends WUserlevels
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WUserlevelsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("wuserlevelslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("wuserlevelslist"); // Return to list
                return;
            }
        }
