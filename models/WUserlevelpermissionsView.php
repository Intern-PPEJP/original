 ...
 * Page class
 */
class WUserlevelpermissionsView extends WUserlevelpermissions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WUserlevelpermissionsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("userlevelid") ?? Route("userlevelid")) !== null) {
                ...
                $returnUrl = "wuserlevelpermissionslist"; // Return to list
            }
            if (($keyValue = Get("_tablename") ?? Route("_tablename")) !== null) {
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "wuserlevelpermissionslist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "wuserlevelpermissionslist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("wuserlevelpermissionslist"), "", $this->TableVar, true);
        $pageId = "view";
