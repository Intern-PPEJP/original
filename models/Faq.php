...
class Faq
{
    ...
    // Table name
    public $TableName = 'faq.php';

    // Page object name
    public $PageObjName = "Faq";
    ...
    public function __construct()
    {
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'faq.php');
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $Breadcrumb->add("custom", "faq", CurrentUrl(), "", "faq", true);
        $this->Heading = $Language->TablePhrase("faq", "TblCaption");
    }
