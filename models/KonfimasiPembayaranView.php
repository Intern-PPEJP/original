 ...
 * Page class
 */
class KonfimasiPembayaranView extends KonfimasiPembayaran
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KonfimasiPembayaranView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("order_id") ?? Route("order_id")) !== null) {
                ...
                $returnUrl = "konfimasipembayaranlist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "konfimasipembayaranlist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "konfimasipembayaranlist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
