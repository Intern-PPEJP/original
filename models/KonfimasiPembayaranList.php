 ...
 * Page class
 */
class KonfimasiPembayaranList extends KonfimasiPembayaran
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KonfimasiPembayaranList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fkonfimasi_pembayaranlist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "konfimasipembayaranadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "konfimasipembayarandelete";
        $this->MultiUpdateUrl = "konfimasipembayaranupdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fkonfimasi_pembayaranlistsrch";
    ...
    protected function hideFieldsForAddEdit()
    {
        ...
        if ($this->isAddOrEdit()) {
            $this->judul_pelatihan->Visible = false;
        }
        if ($this->isAddOrEdit()) {
            $this->tanggal_pelaksanaan->Visible = false;
        }
        if ($this->isAddOrEdit()) {
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fkonfimasi_pembayaranlistsrch", $filters);
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->bukti_pembayaran, $arKeywords, $type);
        return $where;
    }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fkonfimasi_pembayaranlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fkonfimasi_pembayaranlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fkonfimasi_pembayaranlist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fkonfimasi_pembayaranlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
