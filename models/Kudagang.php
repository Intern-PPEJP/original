...
class Kudagang
{
    ...
    // Table name
    public $TableName = 'kudagang.php';

    // Page object name
    public $PageObjName = "Kudagang";
    ...
    public function __construct()
    {
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'kudagang.php');
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $Breadcrumb->add("custom", "kudagang", CurrentUrl(), "", "kudagang", true);
        $this->Heading = $Language->TablePhrase("kudagang", "TblCaption");
    }
