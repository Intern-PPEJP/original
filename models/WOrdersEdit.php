 ...
 * Page class
 */
class WOrdersEdit extends WOrders
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WOrdersEdit";
    ...
    public function run()
    {
        ...
        $this->nama_peserta->Required = false;
        $this->nama_perusahaan->Required = false;
        $this->pelatihan_id->Required = false;
        ...
        switch ($this->CurrentAction) {
            ...
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "worderslist") {
