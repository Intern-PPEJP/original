...
/**
 * Table class for w_userlevels
 */
class WUserlevels extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'w_userlevels';
        $this->TableName = 'w_userlevels';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`w_userlevels`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // userlevelid
        $this->userlevelid = new DbField('w_userlevels', 'w_userlevels', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, 11, -1, false, '`userlevelid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // userlevelname
        $this->userlevelname = new DbField('w_userlevels', 'w_userlevels', 'x_userlevelname', 'userlevelname', '`userlevelname`', '`userlevelname`', 200, 80, -1, false, '`userlevelname`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`w_userlevels`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("wuserlevelslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "wuserlevelsview") {
            return $Language->phrase("View");
        } elseif ($pageName == "wuserlevelsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "wuserlevelsadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "WUserlevelsView";
            case Config("API_ADD_ACTION"):
                return "WUserlevelsAdd";
            case Config("API_EDIT_ACTION"):
                return "WUserlevelsEdit";
            case Config("API_DELETE_ACTION"):
                return "WUserlevelsDelete";
            case Config("API_LIST_ACTION"):
                return "WUserlevelsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("wuserlevelsview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("wuserlevelsview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "wuserlevelsadd?" . $this->getUrlParm($parm);
        } else {
            $url = "wuserlevelsadd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("wuserlevelsedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("wuserlevelsadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("wuserlevelsdelete", $this->getUrlParm());
    }
