 ...
 * Page class
 */
class WSettingsList extends WSettings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WSettingsList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fw_settingslist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "wsettingsadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "wsettingsdelete";
        $this->MultiUpdateUrl = "wsettingsupdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fw_settingslistsrch";
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->Login_Picture); // Login_Picture
            $this->updateSort($this->Register_Picture); // Register_Picture
            $this->updateSort($this->Popup_Show); // Popup_Show
            $this->updateSort($this->Popup_Picture); // Popup_Picture
            $this->updateSort($this->Popup_Link); // Popup_Link
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->ID->setSort("");
                $this->Logo->setSort("");
                $this->Login_Picture->setSort("");
                $this->Register_Picture->setSort("");
                $this->Popup_Show->setSort("");
                $this->Popup_Picture->setSort("");
                $this->Popup_Link->setSort("");
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fw_settingslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fw_settingslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fw_settingslist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
