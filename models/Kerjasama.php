...
class Kerjasama
{
    ...
    // Table name
    public $TableName = 'kerjasama.php';

    // Page object name
    public $PageObjName = "Kerjasama";
    ...
    public function __construct()
    {
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'kerjasama.php');
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $Breadcrumb->add("custom", "kerjasama", CurrentUrl(), "", "kerjasama", true);
        $this->Heading = $Language->TablePhrase("kerjasama", "TblCaption");
    }
