 ...
 * Page class
 */
class WTestimoniDelete extends WTestimoni
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WTestimoniDelete";
    ...
    public function run()
    {
        ...
        $this->link_testimoni->Visible = false;
        ...
        if ($filter == "") {
            $this->terminate("wtestimonilist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("wtestimonilist"); // Return to list
                return;
            }
        }
