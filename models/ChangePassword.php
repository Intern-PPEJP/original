 ...
 * Page class
 */
class ChangePassword extends WUsers
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        $this->OldPassword = new DbField("w_users", "w_users", "opwd", "opwd", "opwd", "", 202, 255, 0, false, "", false, false, false);
        $this->OldPassword->EditAttrs->appendClass("form-control ew-control");
        $this->NewPassword = new DbField("w_users", "w_users", "npwd", "npwd", "npwd", "", 202, 255, 0, false, "", false, false, false);
        $this->NewPassword->EditAttrs->appendClass("form-control ew-control");
        $this->ConfirmPassword = new DbField("w_users", "w_users", "cpwd", "cpwd", "cpwd", "", 202, 255, 0, false, "", false, false, false);
