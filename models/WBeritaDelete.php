 ...
 * Page class
 */
class WBeritaDelete extends WBerita
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WBeritaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("wberitalist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("wberitalist"); // Return to list
                return;
            }
        }
