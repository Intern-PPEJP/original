 ...
 * Page class
 */
class WOrdersDelete extends WOrders
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WOrdersDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("worderslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("worderslist"); // Return to list
                return;
            }
        }
