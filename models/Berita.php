...
class Berita
{
    ...
    // Table name
    public $TableName = 'berita.php';

    // Page object name
    public $PageObjName = "Berita";
    ...
    public function __construct()
    {
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'berita.php');
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $Breadcrumb->add("custom", "berita", CurrentUrl(), "", "berita", true);
        $this->Heading = $Language->TablePhrase("berita", "TblCaption");
    }
