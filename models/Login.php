...
class Login extends WUsers
{
    ...
    public function run()
    {
        ...
        $this->Username = new DbField("w_users", "w_users", "username", "username", "username", "", 202, 255, 0, false, "", false, false, false);
        $this->Username->EditAttrs->appendClass("form-control ew-control");
        $this->Password = new DbField("w_users", "w_users", "password", "password", "password", "", 202, 255, 0, false, "", false, false, false);
        $this->Password->EditAttrs->appendClass("form-control ew-control");
        if (Config("ENCRYPTED_PASSWORD")) {
            $this->Password->Raw = true;
        }
        $this->LoginType = new DbField("w_users", "w_users", "type", "logintype", "logintype", "", 202, 255, 0, false, "", false, false, false);
