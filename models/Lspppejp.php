...
class Lspppejp
{
    ...
    // Table name
    public $TableName = 'lsp-ppejp.php';

    // Page object name
    public $PageObjName = "Lspppejp";
    ...
    public function __construct()
    {
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'lsp-ppejp.php');
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $Breadcrumb->add("custom", "lspppejp", CurrentUrl(), "", "lspppejp", true);
        $this->Heading = $Language->TablePhrase("lspppejp", "TblCaption");
    }
