 ...
 * Page class
 */
class WBeritaList extends WBerita
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WBeritaList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fw_beritalist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "wberitaadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "wberitadelete";
        $this->MultiUpdateUrl = "wberitaupdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fw_beritalistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->url_berita->AdvancedSearch->toJson(), ","); // Field url_berita
        $filterList = Concat($filterList, $this->isi->AdvancedSearch->toJson(), ","); // Field isi
        $filterList = Concat($filterList, $this->kategori_id->AdvancedSearch->toJson(), ","); // Field kategori_id
        $filterList = Concat($filterList, $this->tanggal_publikasi->AdvancedSearch->toJson(), ","); // Field tanggal_publikasi
        $filterList = Concat($filterList, $this->penulis->AdvancedSearch->toJson(), ","); // Field penulis
        ...
        $filterList = Concat($filterList, $this->user_created->AdvancedSearch->toJson(), ","); // Field user_created
        $filterList = Concat($filterList, $this->user_updated->AdvancedSearch->toJson(), ","); // Field user_updated
        $filterList = Concat($filterList, $this->publish->AdvancedSearch->toJson(), ","); // Field publish
        $filterList = Concat($filterList, $this->gambar2->AdvancedSearch->toJson(), ","); // Field gambar2
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fw_beritalistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field url_berita
        $this->url_berita->AdvancedSearch->SearchValue = @$filter["x_url_berita"];
        $this->url_berita->AdvancedSearch->SearchOperator = @$filter["z_url_berita"];
        $this->url_berita->AdvancedSearch->SearchCondition = @$filter["v_url_berita"];
        $this->url_berita->AdvancedSearch->SearchValue2 = @$filter["y_url_berita"];
        $this->url_berita->AdvancedSearch->SearchOperator2 = @$filter["w_url_berita"];
        $this->url_berita->AdvancedSearch->save();

        // Field isi
        $this->isi->AdvancedSearch->SearchValue = @$filter["x_isi"];
        $this->isi->AdvancedSearch->SearchOperator = @$filter["z_isi"];
        $this->isi->AdvancedSearch->SearchCondition = @$filter["v_isi"];
        ...
        // Field kategori_id
        $this->kategori_id->AdvancedSearch->SearchValue = @$filter["x_kategori_id"];
        $this->kategori_id->AdvancedSearch->SearchOperator = @$filter["z_kategori_id"];
        $this->kategori_id->AdvancedSearch->SearchCondition = @$filter["v_kategori_id"];
        $this->kategori_id->AdvancedSearch->SearchValue2 = @$filter["y_kategori_id"];
        $this->kategori_id->AdvancedSearch->SearchOperator2 = @$filter["w_kategori_id"];
        $this->kategori_id->AdvancedSearch->save();
        ...
        // Field penulis
        $this->penulis->AdvancedSearch->SearchValue = @$filter["x_penulis"];
        $this->penulis->AdvancedSearch->SearchOperator = @$filter["z_penulis"];
        $this->penulis->AdvancedSearch->SearchCondition = @$filter["v_penulis"];
        $this->penulis->AdvancedSearch->SearchValue2 = @$filter["y_penulis"];
        $this->penulis->AdvancedSearch->SearchOperator2 = @$filter["w_penulis"];
        $this->penulis->AdvancedSearch->save();
        ...
        // Field user_created
        $this->user_created->AdvancedSearch->SearchValue = @$filter["x_user_created"];
        $this->user_created->AdvancedSearch->SearchOperator = @$filter["z_user_created"];
        $this->user_created->AdvancedSearch->SearchCondition = @$filter["v_user_created"];
        $this->user_created->AdvancedSearch->SearchValue2 = @$filter["y_user_created"];
        $this->user_created->AdvancedSearch->SearchOperator2 = @$filter["w_user_created"];
        $this->user_created->AdvancedSearch->save();

        // Field user_updated
        $this->user_updated->AdvancedSearch->SearchValue = @$filter["x_user_updated"];
        $this->user_updated->AdvancedSearch->SearchOperator = @$filter["z_user_updated"];
        $this->user_updated->AdvancedSearch->SearchCondition = @$filter["v_user_updated"];
        $this->user_updated->AdvancedSearch->SearchValue2 = @$filter["y_user_updated"];
        $this->user_updated->AdvancedSearch->SearchOperator2 = @$filter["w_user_updated"];
        $this->user_updated->AdvancedSearch->save();
        ...
        // Field gambar2
        $this->gambar2->AdvancedSearch->SearchValue = @$filter["x_gambar2"];
        $this->gambar2->AdvancedSearch->SearchOperator = @$filter["z_gambar2"];
        $this->gambar2->AdvancedSearch->SearchCondition = @$filter["v_gambar2"];
        $this->gambar2->AdvancedSearch->SearchValue2 = @$filter["y_gambar2"];
        $this->gambar2->AdvancedSearch->SearchOperator2 = @$filter["w_gambar2"];
        $this->gambar2->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->url_berita, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->isi, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->penulis, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->gambar, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->user_created, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->user_updated, $arKeywords, $type);
        return $where;
    }
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->id->setSort("");
                $this->judul->setSort("");
                $this->url_berita->setSort("");
                $this->isi->setSort("");
                $this->kategori_id->setSort("");
                $this->tanggal_publikasi->setSort("");
                $this->penulis->setSort("");
                $this->gambar->setSort("");
                $this->created_at->setSort("");
                $this->updated_at->setSort("");
                $this->user_created->setSort("");
                $this->user_updated->setSort("");
                $this->publish->setSort("");
                $this->gambar2->setSort("");
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fw_beritalistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fw_beritalistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fw_beritalist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            // isi
            $this->isi->ViewValue = TruncateMemo($this->isi->CurrentValue, 300, $this->isi->TruncateMemoRemoveHtml);
            ...
            if ($this->gambar->UseColorbox) {
                ...
                $this->gambar->LinkAttrs["data-rel"] = "w_berita_x" . $this->RowCount . "_gambar";
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fw_beritalistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
