 ...
 * Page class
 */
class AkunkuView extends Akunku
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("user_id") ?? Route("user_id")) !== null) {
                ...
                $returnUrl = "akunkulist"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "akunkulist"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "akunkulist"; // Not page request, return to list
        }
        if ($returnUrl != "") {
