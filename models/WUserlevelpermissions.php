...
/**
 * Table class for w_userlevelpermissions
 */
class WUserlevelpermissions extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'w_userlevelpermissions';
        $this->TableName = 'w_userlevelpermissions';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`w_userlevelpermissions`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // userlevelid
        $this->userlevelid = new DbField('w_userlevelpermissions', 'w_userlevelpermissions', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, 11, -1, false, '`userlevelid`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tablename
        $this->_tablename = new DbField('w_userlevelpermissions', 'w_userlevelpermissions', 'x__tablename', 'tablename', '`tablename`', '`tablename`', 200, 80, -1, false, '`tablename`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // permission
        $this->_permission = new DbField('w_userlevelpermissions', 'w_userlevelpermissions', 'x__permission', 'permission', '`permission`', '`permission`', 3, 11, -1, false, '`permission`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`w_userlevelpermissions`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("wuserlevelpermissionslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "wuserlevelpermissionsview") {
            return $Language->phrase("View");
        } elseif ($pageName == "wuserlevelpermissionsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "wuserlevelpermissionsadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "WUserlevelpermissionsView";
            case Config("API_ADD_ACTION"):
                return "WUserlevelpermissionsAdd";
            case Config("API_EDIT_ACTION"):
                return "WUserlevelpermissionsEdit";
            case Config("API_DELETE_ACTION"):
                return "WUserlevelpermissionsDelete";
            case Config("API_LIST_ACTION"):
                return "WUserlevelpermissionsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("wuserlevelpermissionsview", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("wuserlevelpermissionsview", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "wuserlevelpermissionsadd?" . $this->getUrlParm($parm);
        } else {
            $url = "wuserlevelpermissionsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("wuserlevelpermissionsedit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("wuserlevelpermissionsadd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("wuserlevelpermissionsdelete", $this->getUrlParm());
    }
