 ...
 * Page class
 */
class WPagesDelete extends WPages
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "WPagesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("wpageslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("wpageslist"); // Return to list
                return;
            }
        }
