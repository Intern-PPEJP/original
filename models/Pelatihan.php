...
class Pelatihan
{
    ...
    // Table name
    public $TableName = 'pelatihan.php';

    // Page object name
    public $PageObjName = "Pelatihan";
    ...
    public function __construct()
    {
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'pelatihan.php');
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $Breadcrumb->add("custom", "pelatihan", CurrentUrl(), "", "pelatihan", true);
        $this->Heading = $Language->TablePhrase("pelatihan", "TblCaption");
    }
