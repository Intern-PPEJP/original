...
$(document).ready(function(){
    ...
    $('#psearch').keyup(function(){
        $('#cari').attr('disabled', $(this).val().length == 0);
    });
});
</script>
    ...
    <script>
        $('.dropdown-submenu a.dropdown-toggle').on("click", function(e) {
            ...
            $parent.find('.dropdown-menu').not($el).hide();
            $el.toggle();
            e.stopPropagation();
            e.preventDefault();
        });
...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" id="mainNav">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?= GetUrl('home')?>">
                <img src="<?= GetUrl('images/logo-kemendag.png') ?>" alt="logo">
            </a>
            <form name="fcari" id="fcari" class="form-inline my-2 my-lg-0" action="<?= GetUrl('caridatalist') ?>" method="get">
                <input class="form-control mr-sm-2" type="search" id="psearch" name="psearch" placeholder="Pencarian..." aria-label="Search" value="<?php echo @$_GET['psearch']; ?>" style="min-width: 80px;">
                <button class="btn btn-outline-success my-2 my-sm-0"  id="cari" type="submit" value="cari">Cari</button>
            </form>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="<?= GetUrl('tentang-kami') ?>">Pusat Pelatihan SDM Ekspor dan Jasa Perdagangan (PPEJP)</a></li>
                            <li><a class="dropdown-item" href="<?= GetUrl('tentang-bpmjp') ?>">Balai Pelatihan SDM Metrologi, Mutu dan Jasa Perdagangan (BPMJP)</a></li>
                            <li class="dropdown-submenu">
                                <a class="dropdown-item dropdown-toggle" href="#">Lembaga Sertifikasi Profesi (LSP)</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown2">
                            <li class="dropdown-submenu">
                                <a class="dropdown-item dropdown-toggle" href="<?= GetUrl('pelatihan') ?>">Pelatihan</a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="<?= GetUrl('pelatihan-jasa-perdagangan') ?>">Pelatihan Jasa</a></li>
                                </ul>
                            </li>
                            <li><a class="dropdown-item" href="<?= GetUrl('export-coaching-program') ?>">Export Coaching Program</a></li>
                ...
                <a class="btn btn-success ml-lg-3 mt-2 mt-lg-0" href="Signin.php" role="button">Masuk</a>
            </div>
        </div>
    </nav>
