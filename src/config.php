...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'vd4eRpjQ34Fwb1XZ', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/ppejp_web.css", // Project stylesheet file name
    ...
    "ADMIN_USER_NAME" => "king@d.d", // Administrator user name
    "ADMIN_PASSWORD" => "fff", // Administrator password
    ...
    "USER_LEVEL_PRIV_TABLE" => "`w_userlevelpermissions`",
    ...
    "USER_TABLE_NAME" => "w_users",
    "LOGIN_USERNAME_FIELD_NAME" => "user_email",
    "LOGIN_PASSWORD_FIELD_NAME" => "pass",
    "USER_ID_FIELD_NAME" => "user_id",
    "PARENT_USER_ID_FIELD_NAME" => "",
    "USER_LEVEL_FIELD_NAME" => "userlevel",
    "USER_PROFILE_FIELD_NAME" => "",
    "REGISTER_ACTIVATE_FIELD_NAME" => "aktif",
    "USER_EMAIL_FIELD_NAME" => "",

    // User table filters
    "USER_TABLE_DBID" => "DB",
    "USER_TABLE" => "`w_users`",
    "USER_NAME_FILTER" => "(`user_email` = '%u')",
    ...
    "SEARCH_FILTER_OPTION" => "None",

    // Email
    "SENDER_EMAIL" => "", // Sender email address
    "RECIPIENT_EMAIL" => "smtp.gmail.com", // Recipient email address
